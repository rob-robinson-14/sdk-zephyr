...
#define NRF_SAADC_ATB2		      (NRF_SAADC_AIN_TEST_SHIM_OFFSET + 0)
#define NRF_SAADC_ATB1		      (NRF_SAADC_AIN_TEST_SHIM_OFFSET + 1)
#define NRF_SAADC_AVSS		      (NRF_SAADC_AIN_TEST_SHIM_OFFSET + 2)
#define NRF_SAADC_SELREF	      (NRF_SAADC_AIN_TEST_SHIM_OFFSET + 3)
